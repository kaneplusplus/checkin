...
You can install the released version of checkin from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("checkin")
```
...
```r
library(checkin)
#> Error in library(checkin): there is no package called 'checkin'
## basic example code
```
